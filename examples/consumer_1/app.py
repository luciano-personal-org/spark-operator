...
# Variables
s3_bucket_name = os.getenv("S3_BUCKET_NAME", "spark-luciano-test-1")
...
def consume_and_write():
    ...
    queue_url = os.getenv("SQS_QUEUE_URL", "https://sqs.us-east-1.amazonaws.com/992382765082/spark-luciano-test-1")
    ...
    if messages:
        ...
        print(f"Writing {len(data)} records to Iceberg...")
